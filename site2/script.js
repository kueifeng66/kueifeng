...
const API_KEY = '35af5c01f0d331eb99f5a42b0259c663';
...
const cityList = [
  ...
  "Amsterdam", "Vienna", "Zurich", "Prague", "Athens",
  

  // Americas
  "New York", "Los Angeles", "Chicago", "Toronto", "Vancouver",
  "Mexico City","Miami", "Las Vegas", "San Francisco",

  // Africa & Oceania
  "Sydney", "Melbourne", "Cape Town",
...
async function getWeather() {
  ...
  smoothRotateTo(coords.lat, coords.lon);
  addMarker(coords.lat, coords.lon,0xff00ff);
...
const texture = new THREE.TextureLoader().load("https://threejs.org/examples/textures/land_ocean_ice_cloud_2048.jpg");
  ...
  controls.enablePan = false;           // disable dragging sideways
  ...
  map: texture,
  bumpMap: new THREE.TextureLoader().load("earthbump4k.jpg"),
  bumpScale: 0.05,
  specularMap: new THREE.TextureLoader().load("earthspec4k.jpg")
});
  ...
  earth.rotation.y = Math.PI; // rotate 180° around Y
...
function addMarker(lat, lon, color) {
  const pos = getVectorFromLatLon(lat, lon, 1.01); // slightly above surface
...
// Test markers
//addMarker(0, 0, 0xff0000);    // Equator, Prime Meridian
//addMarker(0, 90, 0x00ff00);   // Equator, 90°E
//addMarker(0, -90, 0x0000ff);  // Equator, 90°W
//addMarker(90, 0, 0xffff00);   // North Pole

//addMarker(23.5, 121, 0xff00ff) // taiwan


//smoothRotateTo(23.5, 121); // Taiwan
