  ...
  fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${latitude}&lon=${longitude}&appid=${apiKey}`)
    ...
    .then(data => {
       ...
       let maxHumidity = -Infinity;
            ...
            //console.log("Minimum Temperature:", minTemperature.toFixed(1));
            //console.log("Maximum Temperature:", maxTemperature.toFixed(1));
            //console.log("Minimum Humidity:", minHumidity.toFixed(1));
            //console.log("Maximum Humidity:", maxHumidity.toFixed(1));
