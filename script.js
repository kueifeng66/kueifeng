...
const username = 'kueifeng';
const repository = 'kueifeng66';
const accessToken = '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';

// Fetch the last commit time from GitHub
fetch(`https://api.github.com/repos/${username}/${repository}/commits/master`, {
  headers: {
